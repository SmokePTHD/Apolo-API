...
export { GeoJSON as GeoJSONTypeDefinition } from 'graphql-scalars/typings/typeDefs.js';
export { CountryName as CountryNameTypeDefinition } from 'graphql-scalars/typings/typeDefs.js';
export { GraphQLCountryName as CountryNameResolver };
export { GraphQLCountryName };
export { CountryName as CountryNameMock } from 'graphql-scalars/typings/mocks.js';
export { GraphQLGeoJSON as GeoJSONResolver };
export { GraphQLGeoJSON };
export { GeoJSON as GeoJSONMock } from 'graphql-scalars/typings/mocks.js';
